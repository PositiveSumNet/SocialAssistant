...
const ORDER_BY = {
  HANDLE: 'Handle',
  POST_TIME_DESC: 'RecentPosts',
  POST_REPLY_COUNT_DESC: 'MostComments',
  POST_LIKE_COUNT_DESC: 'MostLikes',
  POST_RESHARE_COUNT_DESC: 'MostShares'
};
...
const UPLOAD_CONTEXT = {
  ENTITIES_TO_IMPORT: 'entitiesToImport',
  TWITTER_PROFILES_TO_SCRAPE: 'twitterProfilesToScrape'
};

const MSGTYPE = {
  FROMBG: {
    BG_SCRAPED: 'bgScraped'
  },
  TOBACKGROUND: {
    SAVE: 'save',
    SETBADGE: 'setBadge',
    LETS_SCRAPE: 'letsScrape',
    NITTER_SPEED_TEST: 'nitterSpeedTest',
    LOG_ME: 'logMe'
  },
  TO_OFFSCREEN: {
  ...
  FROMDB: {
    ...
    EXPORT: {
      RETURN_EXPORTED_RESULTS: 'returnExportedResults'
    },
    IMPORT: {
      PROCESSED_SYNC_IMPORT_BATCH: 'processedSyncImportBatch'
    },
    ON_SUCCESS: {
