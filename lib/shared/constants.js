...
const CLS = {
  MASTODON_ACCOUNT_LINK: 'mastodon-account-link',
  MASTODON_FOLLOW_ONE: 'mastodon-follow-one',
  MASTODON_FOLLOWING_ALREADY: 'following-already-mdon',
  MASTODON_FOLLOW_LIKELY_ACCEPTED: 'following-likely-mdon',
  MASTODON_FOLLOW_AWAITING_RESPONSE: 'following-awaits-response-mdon'
};
