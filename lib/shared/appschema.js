...
var APPSCHEMA = {
  ...
  SocialProfileDescription: {
    ...
    SubjectType: DATATYPES.ACCOUNT_HANDLE,
    ObjectType: DATATYPES.TEXT,
    Predicate: SCHEMA_CONSTANTS.PREDICATES.PROFILE.DESCRIPTION,
    OneToOne: true
  },
  ...
  SocialFollowerCount: {
    ...
    Predicate: SCHEMA_CONSTANTS.PREDICATES.PROFILE.FOLLOWER_COUNT,
    OneToOne: true
  },
  ...
  SocialFollowingCount: {
    ...
    SubjectType: DATATYPES.ACCOUNT_HANDLE,
    ObjectType: DATATYPES.INTEGER,
    Predicate: SCHEMA_CONSTANTS.PREDICATES.PROFILE.FOLLOWING_COUNT,
    OneToOne: true
  },
  ...
  SocialSourceIdentifier: {
    ...
    SubjectType: DATATYPES.ACCOUNT_HANDLE,
    ObjectType: DATATYPES.TEXT,
    Predicate: SCHEMA_CONSTANTS.PREDICATES.PROFILE.SOURCE_ID,
    OneToOne: true
  }
