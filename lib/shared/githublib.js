...
var GITHUB = {
  ...
  SHAS: {
    ...
    getBlobSha: async function(relPath, repoConnInfo, repoType) {
      ...
      if (!cachedTreeMeta || containerPath != cachedTreePath) {
        const treeMeta = await GITHUB.SHAS.getMetadataTree(containerPath, repoConnInfo);
        GITHUB.SHAS.cacheTree(treeMeta, containerPath, repoType);
      }
