var SETTINGS = {
  ...
  getBackgroundScrapeUrl: function() {
    return localStorage.getItem(SETTINGS.BG_SCRAPE_URL);
  },

  setBackgroundScrapeUrl: function(url) {
    return localStorage.setItem(SETTINGS.BG_SCRAPE_URL, url);
  },

  clearBackgroundScrapeUrl: function() {
    return localStorage.removeItem(SETTINGS.BG_SCRAPE_URL);
  },
