var SETTINGS = {
  ...
  getCachedOwner: function(site) {
    // backward compatibility
    return localStorage.getItem(SETTINGS.ownerCacheKey(site)) || 
      localStorage.getItem(SETTINGS.ownerCacheKey());
  },

  getCachedPageType: function(site) {
    // backward compatibility
    return localStorage.getItem(SETTINGS.pageTypeCacheKey(site)) || 
      localStorage.getItem(SETTINGS.pageTypeCacheKey());
  },

  getCachedSite: function() {
    return localStorage.getItem(SETTINGS.PAGE_CONTEXT.SITE);
  },
  ...
  cachePageState: function(msg) {
    ...
    if (msg.site) {
      localStorage.setItem(SETTINGS.PAGE_CONTEXT.SITE, msg.site);
    }
