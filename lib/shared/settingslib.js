var SETTINGS = {
  ...
  NITTER: {
    ...
    getNitterDomain: async function() {
      ...
      let speedTestSetting = await SETTINGS.getStorageValue(SETTINGS.NITTER.SPEED_TEST.CACHE_KEY);

      if (!speedTestSetting || !speedTestSetting[SETTINGS.NITTER.SPEED_TEST.WINNER]) {
        // surprising, since we run speed test
        console.log('Default for nitter');
        return defaultDomain;
      }

      return speedTestSetting[SETTINGS.NITTER.SPEED_TEST.WINNER];
    },
