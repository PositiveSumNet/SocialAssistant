...
var QUERYWORK_UI = {
  ...
  bindElements: function() {
    ...
    document.getElementById('listTopicPicker').onclick = function(event) {
      console.log('clicked topic choice');
      // txtTopicFilter.value = QUERYING_UI.OWNER.handleFromClickedOwner(event);
      // QUERYWORK_UI.onChooseOwner();
    };
    // auto-populate with a few owners on-focus (if empty)
  ...
  bindTypeahead: function(
    ...
    listPickerElm) {
    // handle backspace
    textBoxElm.addEventListener('keydown', function(event) {
