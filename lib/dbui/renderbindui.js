...
var RENDERBIND_UI = {
  ...
  onRequestEmbeddedVideo: async function(a) {
    ...
    if (STR.hasLen(b64DataUri)) {
      ...
      ES6.swapImgForVideo(mediaParent, imgElm, b64DataUri);
    }
    else {
      ...
      a.querySelector('span').textContent = 'Video launched and downloaded in a separate tab. For seamless viewing, try the Backups tab -> Upload Videos feature.';
