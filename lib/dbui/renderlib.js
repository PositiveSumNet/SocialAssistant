  ...
  POST: {
    ...
    TAGGING: {
      ...
      renderTagControl: function(post) {
        ...
        if (topicRatings && topicRatings.length > 0) {
          // TEMPORARILY allowing only a single tag
          const topicRating = topicRatings[0];
        ...
        // todo: could introduce guessing tag based on keywords
