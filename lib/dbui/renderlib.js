var RENDER = {
  ...
  POST: {
    ...
    renderLinkedTimestamp: function(post) {
      return `
      <span class='basicSep'> | </span>
    ...
    renderReplyTo: function(post, site) {
      ...
      const linkedTime = RENDER.POST.renderLinkedTimestamp(post.ReplyToTweet);
    ...
    renderPostBody: function(post, site) {
      ...
      const linkedTime = RENDER.POST.renderLinkedTimestamp(post);
