var RENDER = {
  ...
  POST: {
    ...
    TAGGING: {
      ...
      getElmSubtopicName: function(subTopicBtn) {
      ...
      //   return Array.from(subtopicsUl.querySelectorAll('li.subTopicBtn subTopicLnk')).find(function(li) {
      //     let elmSubtopicName = RENDER.POST.TAGGING.getElmTopicName(li);
