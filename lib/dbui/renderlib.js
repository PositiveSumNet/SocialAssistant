var RENDER = {
  ...
  POST: {
    ...
    TAGGING: {
      ...
      renderTopicAnchor: function(topicDiv, topic, specialOnClick) {
        ...
        topicA.href = '#';
        topicA.textContent = topic.Name || topic;
      ...
      renderTopicChoice: function(topicsUl, topic, isSelected, specialOnClick, insertBeforeElm) {
        ...
        RENDER.POST.TAGGING.renderTopicAnchor(topicDiv, topic, specialOnClick);
        // const topicUl = document.createElement('ul');
        // topicDiv.appendChild(topicUl);
      ...
      renderTopicChoices: function(postScoredTaggerElm) {
        ...
        let clearSelectionElm = RENDER.POST.TAGGING.renderTopicChoice(topicsUl, TAGGING.CONSTANTS.TAG_REMOVE, false, RENDER.POST.TAGGING.clickClearSelection);
        ...
        let addAnotherElm = RENDER.POST.TAGGING.renderTopicChoice(topicsUl, TAGGING.CONSTANTS.REQUEST_TOPIC, false, RENDER.POST.TAGGING.clickRequestNewTopic);
