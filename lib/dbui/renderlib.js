var RENDER = {
  ...
  POST: {
    ...
    renderLinkedTimestamp: function(post, site) {
      ...
      <a href='${STR.expandTweetUrl(post.PostUrlKey, 'nitter.net')}' target='_blank' data-toggle='tooltip' title='Review on nitter.net'>N1</a>
      <a href='${STR.expandTweetUrl(post.PostUrlKey, 'nitter.cz')}' target='_blank' title='Review on nitter.cz'>N2</a>
      `;
    },
