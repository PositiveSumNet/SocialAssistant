  ...
  POST: {
    ...
    TAGGING: {
      ...
      clickClearSelection: function(event) {
        ...
        txtBox.value = CMB_SPECIAL.TAG_RATE;
      ...
      renderTopicChoices: function(postScoredTaggerElm) {
        ...
        let clearSelectionElm = RENDER.POST.TAGGING.renderTopicChoice(topicsUl, CMB_SPECIAL.TAG_REMOVE, false, RENDER.POST.TAGGING.clickClearSelection);
        ...
        let addAnotherElm = RENDER.POST.TAGGING.renderTopicChoice(topicsUl, CMB_SPECIAL.REQUEST_TAG, false, RENDER.POST.TAGGING.clickRequestNewTopic);
      ...
      renderTagControl: function(topicRating) {
        ...
        const textDisplay = postSubtopicValue || CMB_SPECIAL.TAG_RATE;
