  ...
  POST: {
    ...
    TAGGING: {
      ...
      clickSubtopicAnchor: function(event) {
        ...
        TAGGING.POSTS.setRatingWorker(postScoredTaggerElm, undefined, concatName);
        return false;
      },
      ...
      configureTagAndRate: function(postScoredTaggerElm) {
        ...
        for (let i = 0; i < starAnchors.length; i++) {
          ...
          starAnchor.onclick = function(event) {
            let concatSubtopic = postScoredTaggerElm.getAttribute('data-testid');
            TAGGING.POSTS.setRatingWorker(postScoredTaggerElm, i + 1, concatSubtopic);
            return false;
          }
        }
      },
