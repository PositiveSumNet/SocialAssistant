var RENDER = {
  ...
  POST: {
    ...
    TAGGING: {
      ...
      renderTopicChoice: function(topicsUl, topic, isSelected, specialOnClick) {
      ...
      renderTopicChoices: function(postScoredTaggerElm) {
        ...
        RENDER.POST.TAGGING.renderTopicChoice(topicsUl, CMB_SPECIAL.TAG_REMOVE, false, RENDER.POST.TAGGING.clickClearSelection);
        ...
        RENDER.POST.TAGGING.renderTopicChoice(topicsUl, CMB_SPECIAL.REQUEST_TAG, false, RENDER.POST.TAGGING.clickRequestNewTopic);
