  ...
  POST: {
    ...
    renderPostImage: function(imgCdnUrl, img64Url) {
      ...
      <div class='postContentImg'>
        ...
        <div><img alt='src-img' src='${imgSrc}' style='max-width:400px;max-height:400px;'/></div>
      </div>`;
    },
    ...
    renderViewThreadBtn: function(post) {
      ...
      return `<a href='#' class='btnViewThread' data-testid='${post[POST_SEL.ThreadUrlKey]}'>${EMOJI.THREAD}${convoCount}</a>`;
    },
