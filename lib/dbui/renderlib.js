var RENDER = {
  ...
  renderPerson: function(person, context, renderAnchorsRule, filtered) {
    ...
    let site = person.Site || SITE.TWITTER;
    ...
    if (img64Url && img64Url.length > 50) {
      img = `<img alt='${handle}' ${imgStyling}${imgClass} src='data:image/${imgType};base64,${img64Url}'/>`;
    }
    ...
    // }
      ...
      img = `<img alt='${handle}' ${imgStyling}${imgClass} src='/images/noprofilepic.png'/>`;
    }
