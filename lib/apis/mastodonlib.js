...
var MASTODON = {
  ...
  followAllVisibleMastodonAccounts: function() {
    ...
    const accounts = ES6.distinctify(anchors.map(function(a) { return STR.MASTODON.accountFromProfileUrl(a.href); }));
    console.log(accounts);
  },

  listenToFollow: function(scope) {
    Array.from(scope.querySelectorAll(`a.${CLS.MASTODON_FOLLOW_ONE}`)).forEach(function(a) {
