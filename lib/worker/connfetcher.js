...
// and/or (b) use GROUP BY / MAX on executeSearch to avoid duplicates being returned (esp. re mastodon "where I'm following" joiners)
...
var CONNFETCHER = {
  ...
  MASTODON_CONDITION_WRITER: {
    ...
    // using the same aliases as executeSearch()
  ...
  executeSearch: function(request) {
