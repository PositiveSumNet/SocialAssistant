...
var TWEET_SAVE_MAPPER = {
  ...
  mapRecordIntoSet: function(record, set, graph) {
    ...
    set.getSubset(APPSCHEMA.SocialPostThreadUrlKey.Name).sogs.push(...pThreadUrlKeys);
    ...
    set.getSubset(APPSCHEMA.SocialPostReplyCount.Name).sogs.push(...sReplyCounts);
    set.getSubset(APPSCHEMA.SocialPostLikeCount.Name).sogs.push(...sLikeCounts);
    set.getSubset(APPSCHEMA.SocialPostReshareCount.Name).sogs.push(...sReshareCounts);
